-- Migration 015 — Faturacao Masterway
-- Tabelas: clientes_faturacao, faturas, notas_credito
-- ADR-025 | Nivel ISA-95: 4 (ERP)
...
VALUES ('migration', '015', 'CREATE', '{"descricao": "Faturacao Masterway (clientes_faturacao, faturas, notas_credito)"}'::jsonb);
